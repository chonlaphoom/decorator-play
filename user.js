            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        console.log("Method ".concat(propertyKey, " has been added to the queue."));
                        return [4 /*yield*/, originalMethod.apply(this, args)];
                    case 1:
                        result = _a.sent();
                        console.log("Method ".concat(propertyKey, " has completed."));
...
function queue() {
    return function (target, propertyKey, descriptor) {
        ...
        descriptor.value = function () {
            ...
            store.push(function () { return originalMethod.apply(_this, args); });
            return;
        };
    };
}
var User = function () {
    ...
    return _a = /** @class */ (function () {
            ...
            User.prototype.getName = function (b) {
                var _this = this;
